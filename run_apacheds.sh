...
changeType: modify
add: objectClasses
objectClasses: ( 2.2.3.4.5.6.7.8.9.0 NAME 'user' DESC 'active directory user' SUP top STRUCTURAL MUST ( cn ) MAY ( sn $ userPassword $ mail $ samAccountName $ givenName $ telephoneNumber $ ou $ title $ memberOf ) X-SCHEMA 'core' )
